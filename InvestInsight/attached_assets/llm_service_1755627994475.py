...
class LLMService:
    ...
    async def _fallback_response(self, prompt: str) -> str:
        ...
        fallback_responses = {
            ...
            "recommendation": "Investment recommendations require LLM analysis. Please ensure Ollama is running.",
            "sentiment": "Sentiment analysis temporarily unavailable.",
            "summary": "Text summary temporarily unavailable."
        }
        ...
        return "AI analysis temporarily unavailable. Please ensure Ollama is running with required models."
    ...
    async def _fallback_chat_response(self, messages: List[Dict[str, str]]) -> str:
        ...
        if "portfolio" in last_message.lower():
            return "Portfolio analysis requires AI model access. Please ensure Ollama is running."
        elif "stock" in last_message.lower():
            return "Stock analysis requires AI model access. Please check your local LLM setup."
        else:
            return "I'm currently unable to process your request. Please ensure the AI models are available."
    ...
    def get_model_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "service_status": "online" if self.available_models else "offline"
        }
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            health_status = {
                "status": "healthy" if "ok" in test_response.lower() else "degraded",
